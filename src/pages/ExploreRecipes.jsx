...
export default function ExploreRecipes() {
  ...
  const sortRecipes = (recipes) => {
    switch (sortOption) {
      ...
      case "calories-asc":
        return [...recipes].sort((a, b) => a.nutrition.calories - b.nutrition.calories);
      case "calories-desc":
        return [...recipes].sort((a, b) => b.nutrition.calories - a.nutrition.calories);
      case "protein-asc":
        return [...recipes].sort((a, b) => b.nutrition.protein_g - a.nutrition.protein_g);
      case "protein-desc":
        return [...recipes].sort((a, b) => a.nutrition.protein_g - b.nutrition.protein_g);
      default:
        return recipes;
    }
  };
    ...
    <div>
      ...
      <div style={{ paddingTop: "90px" }}>
        ...
        <Form className="mb-3" onSubmit={(e) => e.preventDefault()}>
          <Form.Group style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "10px" }}>
            <Form.Label><strong>Filter by Ingredients</strong></Form.Label>
            ...
            <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", justifyContent: "center" }}>
              <Form.Control
                ...
                style={{ width: "250px" }}
              />
              <Button variant="secondary" onClick={handleAddIngredient}>Add</Button>
              {ingredientsList.length > 0 && (
                <Button variant="outline-danger" onClick={handleClearIngredients}>Clear ingredients</Button>
              )}
            </div>
            ...
            <div style={{ marginTop: "10px" }}>
              {ingredientsList.map((ingredient) => (
                <Badge
                  ...
                  bg="info"
                  text="dark"
                  style={{ marginRight: "6px", cursor: "pointer", fontSize: "16px", padding: "8px" }}
            ...
            <Form.Group style={{ marginTop: "20px", width: "250px" }}>
              <Form.Label><strong>Sort Recipes</strong></Form.Label>
              <Form.Select
                value={sortOption}
              ...
              >
                ...
                <option value="protein-asc">Protein (High → Low)</option>
                <option value="protein-desc">Protein (Low → High)</option>
              </Form.Select>
            </Form.Group>
          </Form.Group>
        </Form>
        ...
        <Container fluid>
          ...
          {filteredRecipes.length === 0 && (
            <h3 style={{ marginTop: "30px", color: "gray", textAlign: "center" }}>
              No matching recipes.
            </h3>
          )}
        </Container>
